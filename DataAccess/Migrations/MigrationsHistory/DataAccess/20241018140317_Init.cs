        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkingTimeFrom = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WorkingTimeTo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WorkingTimeSummary = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeWorkSession", x => x.WorkSessionId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeId = table.Column<int>(type: "int", nullable: false),
                    OriderTime = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ToDoListTasks", x => x.TodoTaskId);
                });
